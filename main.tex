...
\addbibresource{chapters/bibliography.bib} % bibliografia generală
\addbibresource{chapters/usefulLinks.bib}   % bibliografia cu linkuri (ex-multibib)
...
\begin{document}
    ...
    \printbibliography[notkeyword=links, title={Bibliography}]
    \printbibliography[keyword=links, title={Useful Links}]
\end{document}
...
%- raport de performanta al SmartScan
